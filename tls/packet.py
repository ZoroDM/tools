...
def encode_client_request(dataSizeFromServer, paddingDataSize, print_detail=print_client_req_packet_detail):
    ...
    req_packet_id = client_req_packet_id + 1
    ...
    print_packet(f"request packet [id:{req_packet_id}] [len:{packet_len} bytes] [will_req_data:{dataSizeFromServer} bytes]", print_packet_data)
